 ...
 */
public class LearnExtendingPagerAdapter extends PagerAdapter {
     ...
     * @param object 在 {@link LearnExtendingPagerAdapter#instantiateItem(ViewGroup, int)} 中提交给 ViewPager 进行保存的实例对象
     * @return 是否相互对应
     */
    @Override
